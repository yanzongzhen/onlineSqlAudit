...
class send_email(object):
    ...
    def send_mail(self, mail_data=None, type=None):
        if type == 0:  # 执行
            text = '<html><body><h1>SQL查询审核平台 工单执行通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
            ...
            text = '<html><body><h1>SQL查询审核平台 工单驳回通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>地址: <a href="%s">%s</a></p>' \
                   '<br><p>状态: 驳回</p>' \
            ...
            text = '<html><body><h1>SQL查询审核平台 权限申请通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>状态: 申请</p>' \
                   '</body></html>' % (
            ...
            text = '<html><body><h1>SQL查询审核平台 权限同意通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>状态: 同意</p>' \
                   '</body></html>' % (
            ...
            text = '<html><body><h1>SQL查询审核平台 权限驳回通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>状态: 驳回</p>' \
                   '</body></html>' % (
            ...
            text = '<html><body><h1>SQL查询审核平台 查询申请通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>状态: 提交</p>' \
                   '</body></html>' % (
            ...
            text = '<html><body><h1>SQL查询审核平台 查询同意通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>状态: 同意</p>' \
                   '</body></html>' % (
            ...
            text = '<html><body><h1>SQL查询审核平台 查询驳回通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>状态: 驳回</p>' \
                   '</body></html>' % (
            ...
            text = '<html><body><h1>SQL查询审核平台 工单转移通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>地址: <a href="%s">%s</a></p>' \
                   '<br><p>状态: 提交至执行人</p>' \
            ...
            text = '<html><body><h1>SQL查询审核平台 工单提交通知</h1>' \
                   '<br><p>工单号: %s</p>' \
                   '<br><p>发起人: %s</p>' \
                   '<br><p>地址: <a href="%s">%s</a></p>' \
                   '<br><p>工单备注: %s</p>' \
        ...
        msg['From'] = self._format_addr('SQL查询审核平台_Admin <%s>' % self.email['user'])
        msg['Subject'] = Header('SQL查询审核平台 工单消息推送', 'utf-8').encode()
        msg['Cc'] = self.email['user']
        if self.email['ssl']:
        ...
        server.sendmail(self.email['user'], [self.email['user'], self.to_addr], msg.as_string())
        server.quit()
