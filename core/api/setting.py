    ...
    def put(self, request, args: str = None):
        ...
        try:
            if args == '1':  # ldap测试
                ...
                msg = MIMEText('SQLAudit Plaform test Message!', 'plain', 'utf-8')
                msg['From'] = _format_addr('SQLAudit_Admin <%s>' % mail['user'])
                ...
                server.sendmail(mail['user'], [mail['user'],mail['to_user']], msg.as_string())
                server.quit()
